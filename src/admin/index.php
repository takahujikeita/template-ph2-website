...
//問題：questionsが定義されていない
//1、DBに繋がっていない(Connection to db とでているからこれはない)
//2,クエリがおかしい(fetchAll()の戻り値が怪しい)
//3,session_start()を有効にしろと言われた(でもこれを有効にすると怒られる)
                ...
                <tr id="question-<?= $question["id"] ?>">
                  ...
                  <td>
                    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                      ...
                      <input type="submit" value="削除" class="submit" onclick="return confirm('本当に削除しますか？');">
                    </form>
                  </td>
                </tr>
              <?php } ?>
